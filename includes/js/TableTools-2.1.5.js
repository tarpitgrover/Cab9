...
TableTools.prototype = {
	...
	"_fnCollectionShow": function ( nButton, oConfig )
	{
		...
		nHidden.setAttribute('role', 'menu');
		nHidden.setAttribute('aria-labelledby', 'dLabel');
		nButton.parentNode.appendChild( nHidden );
...
TableTools.BUTTONS = {
	...
	"collection": $.extend( {}, TableTools.buttonBase, {
		"sAction": "collection",
		"sButtonClass": "dropdown-toggle uppercase",
...
TableTools.DEFAULTS = {
	...
	"oTags": {
		"container": "div",
		"button": "span", // We really want to use buttons here, but Firefox and IE ignore the
